...
# ingest & validate file, parse attributes
def getJsonAttributes(obj: Union[dict, list], prefix: str="") -> Set[str]: ## Chat GPT credit (don't look at me)
